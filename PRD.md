...
**Funcionalidades:**
- **Countdown regressivo:** Contagem em tempo real (dias, horas, minutos, segundos) até o jogo de abertura (11 de junho de 2026, **16h** horário de Brasília — México vs. África do Sul, Estádio Azteca). Deve detectar data passada e exibir estado pós-início (ex: "A Copa está rolando!") com link pros jogos do dia. Três estados: antes / durante / depois do torneio.
